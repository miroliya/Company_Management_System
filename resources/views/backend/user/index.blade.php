                                            ...
                                            <tr id="table_id_{{ $singleData->id }}">
                                                ...
                                                <td>
                                                    <div class="btn-group">
                                                        ...
                                                        <a href="{{ route('admin.user.addpermission', $singleData->id) }}"
                                                            class="btn btn-warning">Permission</a>
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                <select class="custom-select form-control" id="user_status"
                                    data-placeholder="Type to search cities" name="user_status">
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        datavalue += ' <a href="/admin-dashboard/admin-addpermission/' +
                            data.id +
                            '" class="btn btn-warning waves-effect waves-float waves-light">Permission</a>';
