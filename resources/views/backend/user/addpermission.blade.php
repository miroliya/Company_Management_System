                                                ...
                                                @if (in_array(1, $permission))
                                                    <div
                                                        ...
                                                        <input type="checkbox" data-id="1"
                                                            class="checkModule custom-control-input" name="userPermission"
                ...
                $('body').on('click', '.checkModule', function() {
                    ...
                    $.ajax({
                        ...
                        success: function(data) {
                            if (data == "added") {
                                toastr.success('Successfully Permission Added For User',
                                    'Permission Added');
                            } else {
                                toastr.info('Successfully Permission Removed For User',
                                    'Permission Removed');
                            }
                        }
                    });
