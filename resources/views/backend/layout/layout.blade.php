...
<head>
    ...
    <link rel="stylesheet"
        href="{{ asset('resources') }}/plugins/tempusdominus-bootstrap-4/css/tempusdominus-bootstrap-4.min.css">
    <!-- iCheck -->
...
<body class="hold-transition sidebar-mini layout-fixed">
      ...
      <span class="brand-text font-weight-light">{{$setting->site_name}}</span> --}}
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    <div class="image">
                        <img src="{{ asset('resources') }}/dist/img/user2-160x160.jpg" class="img-circle elevation-2"
                            alt="User Image">
                    </div>
                    <div class="info">
        ...
        <div class="modal fade show" id="changepassword" style="display: none; padding-right: 17px;" aria-modal="true"
            role="dialog">
    ...
    <!-- Tempusdominus Bootstrap 4 -->
    <script src="{{ asset('resources') }}/plugins/tempusdominus-bootstrap-4/js/tempusdominus-bootstrap-4.min.js">
    </script>
    <!-- Summernote -->
